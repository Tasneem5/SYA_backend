...
<body>
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="men-dropdown">
              ...
              <a class="dropdown-item" href="frock.jsp">custom design</a>    
            </div>
          </li>
          <li class="nav-item dropdown">
	...
	<div class="container-fluid banner">
		<h1 class="text-uppercase text-light font-weight-light p-4">mens wear (shirts)</h1>
		<nav aria-label="breadcrumb" class="p-0 my-2" style="background-color: rgba(0,0,0,0.35);">
		  <ol class="breadcrumb">
		    <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
		    <li class="breadcrumb-item active" aria-current="page">Men wear (shirts)</li>
		  </ol>
		</nav>
	</div>
	...
	<div class="container-fluid p-2 px-4 category">
		<div class="card-deck">
			<a href="mens.jsp" class="card bg-dark text-white">
			  <img class="card-img" src="images/banner3.jpg" alt="Card image">
			  <div class="card-img-overlay">
			    <h6 class="card-title">shirts</h6>
			  </div>
			</a>
			<a href="menjeans.jsp" class="card bg-dark text-white">
			  <img class="card-img" src="images/banner4.jpg" alt="Card image">
			  <div class="card-img-overlay">
			    <h6 class="card-title">jeans</h6>
			  </div>
			</a>
			<a href="mentrouser.jsp" class="card bg-dark text-white">
			  <img class="card-img" src="images/banner3.jpg" alt="Card image">
			  <div class="card-img-overlay">
			    <h6 class="card-title">trouser</h6>
			  </div>
			</a>
			<a href="tshirt.jsp" class="card bg-dark text-white">
			  <img class="card-img" src="images/banner3.jpg" alt="Card image">
			  <div class="card-img-overlay">
