...
<head>
	<meta charset="UTF-8">
	<title>Men's Wear trouser</title>
...
<body>
	...
	<div class="container-fluid banner">
		<h1 class="text-uppercase text-light font-weight-light p-4">mens wear (trouser)</h1>
		<nav aria-label="breadcrumb" class="p-0 my-2" style="background-color: rgba(0,0,0,0.35);">
		  <ol class="breadcrumb">
		    <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
		    <li class="breadcrumb-item active" aria-current="page">Men wear (trouser)</li>
		  </ol>
		</nav>
	</div>
	...
	<div class="container-fluid p-2 px-4 category">
		<div class="card-deck">
			<a href="men.jsp" class="card bg-dark text-white">
			...
			<a href="mentshirt.jsp" class="card bg-dark text-white">
			  <img class="card-img" src="images/banner3.jpg" alt="Card image">
			  <div class="card-img-overlay">
