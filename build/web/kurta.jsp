...
<head>
  <meta charset="UTF-8">
  <title>women's Wear kurta</title>
...
<body>
  ...
  <div class="container-fluid banner">
    <h1 class="text-uppercase text-light font-weight-light p-4">women's wear (kurta)</h1>
    <nav aria-label="breadcrumb" class="p-0 my-2" style="background-color: rgba(0,0,0,0.35);">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">women's wear (kurta)</li>
      </ol>
    </nav>
  </div>
