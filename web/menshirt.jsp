...
<body>
	...
	<div class="container-fluid banner">
		<h1 class="text-uppercase text-light font-weight-light p-4">mens wear (t-shirt)</h1>
		<nav aria-label="breadcrumb" class="p-0 my-2" style="background-color: rgba(0,0,0,0.35);">
		  <ol class="breadcrumb">
		    <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
		    <li class="breadcrumb-item active" aria-current="page">Men wear (t-shirt)</li>
		  </ol>
		</nav>
	</div>
